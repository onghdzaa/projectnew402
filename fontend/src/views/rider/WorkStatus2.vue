<template>
  <Layout>
     ...
     <div class="card">
       ...
       <br>
             <header>
               <div>ขั้นตอนที่ 2 : <i class="fa fa-pencil-square" > </i> อัพเดทสถานะการให้บริการ</div>
 ...
 <br><br>
      ...
      <div class="row " style="margin-top:0% !important;">
        ...
        <div class="col-sm-8">
        <div> พนักงานไปถึงที่อยู่ลูกค้าแล้ว <i class="fa fa-map-marker" aria-hidden="true"></i> </div>
        <br>
